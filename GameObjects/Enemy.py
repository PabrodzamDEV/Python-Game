...
class Enemy:
    def __init__(self, x, y, batch=None):
        ...
        # The enemy first appears and then stays in idle animation until death, when it vanishes
    ...
    def update(self, player, border, win_size: Tuple, dt):
        ...
        """
        Detects if the enemy has been killed, given that the player is attacking
        and the enemy is in range of the player's attack.
        
        Parameters:
            player (Player): The player object.
        
        Returns:
            bool: True if the enemy should be killed, False otherwise.
        """
    def detect_death(self, player):
        return (((
